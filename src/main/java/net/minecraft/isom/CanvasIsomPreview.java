...
import net.minecraft.client.enums.EnumOSIsom;
import net.minecraft.client.renderer.IsoImageBuffer;
import net.minecraft.util.TerrainTextureManager;
import net.minecraft.util.thread.ThreadRunIsoClient;
import net.minecraft.world.World;
import net.minecraft.world.WorldIso;
